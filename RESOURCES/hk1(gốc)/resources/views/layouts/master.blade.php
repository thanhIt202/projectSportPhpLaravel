...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="@yield('link')assets/css/bootstrap.min.css">

    <!-- Customizable CSS -->
    <link rel="stylesheet" href="@yield('link')assets/css/main.css">
    <link rel="stylesheet" href="@yield('link')assets/css/blue.css">
    <link rel="stylesheet" href="@yield('link')assets/css/owl.carousel.css">
    <link rel="stylesheet" href="@yield('link')assets/css/owl.transitions.css">
    <link rel="stylesheet" href="@yield('link')assets/css/animate.min.css">
    <link rel="stylesheet" href="@yield('link')assets/css/rateit.css">
    <link rel="stylesheet" href="@yield('link')assets/css/bootstrap-select.min.css">

    <!-- Icons/Glyphs -->
    <link rel="stylesheet" href="@yield('link')assets/css/font-awesome.css">
    <link rel="stylesheet" href="@yield('link')assets/css/simple-line-icons.css">
    <link rel="stylesheet" href="@yield('link')assets/css/simple-line-icons.css">
...
<body class="cnt-home">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                        <div class="logo"> <a href="{{ url('/') }}"> <img
                                    src="@yield('link')assets/images/logo.png" alt="logo"> </a> </div>
                        <!-- /.logo -->
                    </div>
                    <!-- /.logo-holder -->
                        ...
                        <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart"
                                ...
                                <div class="items-cart-inner">
                                    ...
                                    <div class="basket-item-count"><span
                                            class="count">{{ $cart->totalQuantity }}</span>
                                    </div>
                                    <div class="total-price-basket"> <span class="lbl"></span> <span
                                            class="total-price"> <span class="value">{{ $cart->totalPrice }}</span>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div class="module-body">
                            <ul class='list-unstyled'>
                                ...
                                <li class=" last"><a href="contact-us.html" title="Suppliers">Liên hệ chúng tôi</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.module-body -->
    ...
    <script src="@yield('link')assets/js/jquery-1.11.1.min.js"></script>
    <script src="@yield('link')assets/js/bootstrap.min.js"></script>
    <script src="@yield('link')assets/js/bootstrap-hover-dropdown.min.js"></script>
    <script src="@yield('link')assets/js/owl.carousel.min.js"></script>
    <script src="@yield('link')assets/js/countdown.js"></script>
    <script src="@yield('link')assets/js/echo.min.js"></script>
    <script src="@yield('link')assets/js/jquery.easing-1.3.min.js"></script>
    <script src="@yield('link')assets/js/bootstrap-slider.min.js"></script>
    <script src="@yield('link')assets/js/jquery.rateit.min.js"></script>
    <script src="@yield('link')assets/js/lightbox.min.js"></script>
    <script src="@yield('link')assets/js/bootstrap-select.min.js"></script>
    <script src="@yield('link')assets/js/wow.min.js"></script>
    <script src="@yield('link')assets/js/scripts.js"></script>
    <!-- Hot Deals Timer 1-->
    @yield('JS')
