  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Quản lý Color</span> <i class="fa fa-angle-left pull-right"></i>
                    <ul class="treeview-menu">
                        <li><a href="{{ route('color.index') }}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Quản lý Size</span> <i class="fa fa-angle-left pull-right"></i>
                    <ul class="treeview-menu">
                        <li><a href="{{ route('size.index') }}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
                        <li><a href="{{ route('size.create') }}"><i class="fa fa-circle-o"></i> Thêm mới</a></li>
                    </ul>
                </a>
                <ul class="treeview-menu">
                </ul>
