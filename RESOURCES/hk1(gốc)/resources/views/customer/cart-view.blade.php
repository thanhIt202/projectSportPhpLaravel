                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th class="cart-edit item">Màu</th> -->
                                            <!-- <th class="cart-edit item">Khích thước</th> -->
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="shopping-cart-btn">
                                                    <span class="">
                                                        <a href="{{ route('home.index') }}" class="btn btn-primary">Tiếp tục
                                                            mua
                                                            hàng</a>
                                                        <a href="{{ route('cart.clear') }}"
                                                            onclick="return confirm('Bạn chắc chưa?')"
                                                            class="btn btn-upper btn-danger pull-right outer-right-xs">Xóa
                                                            giỏ
                                                            hàng</a>
                                                    </span>
                                            ...
                                            <form action="{{ route('cart.update', $item->id) }}" method="get">
                                                <tr>
                                                        ...
                                                        <div class="cart-product-info">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                    name="size" value="{{ $item->size->id }}" checked>
                                                                {{ $item->size->name }}
                                                            </label>
                                                        </div>
                                                        <div class="cart-product-info">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                    name="color" value="{{ $item->color->id }}" checked>
                                                                {{ $item->color->name }}
                                                            </label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="cart-product-sub-total"><span
                                                            class="cart-sub-total-price">{{ $item->buy_price }} đ</span>
                                                    </td>
                                                    <td class="cart-product-grand-total"><span
                                                            class="cart-grand-total-price">{{ $item->quantity * $item->buy_price }}
                                                            đ</span></td>
                                                    <td class="romove-item"><a
                                                            href="{{ route('cart.remove', [$item->id, $item->color, $item->size]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="cart-sub-total">
                                                Tổng :<span class="inner-left-md">{{ $cart->totalPrice }} Đ</span>
                                            </div>
                                        </th>
                                    </tr>
                                    <tbody>
