    ...
    <div class="body-content " id="top-banner-and-menu">
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <x-list-product :products="$newProduct" :title="'SẢN PHẨM MỚI NHẤT'" :status="'Mới'" />
        ...
        <div class="bestsellers1">
            <div class="bestseller">
                <div class="container">
                    <h2><b>SẢN PHẨM ĐẮT TIỀN NHẤT</b></h2>

                    <x-hot-product :products="$hotProduct" :title="'SẢN PHẨM ĐẮT TIỀN NHẤT'" />
                        ...
                        <div class="hidden-md col-sm-4 col-lg-4">
                            <div class="info-box">
                                ...
                                <div class="icon-text">
                                    ...
                                    <h6 class="text">Giao hàng cho các đơn đặt hàng trên 500k</h6>
                                </div>
                            </div>
                        </div>
                        <!-- .col -->
